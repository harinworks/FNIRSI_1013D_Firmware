...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_sd_card_bootloader.elf

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_sd_card_bootloader.elf: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	arm-none-eabi-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_sd_card_bootloader.elf ${OBJECTFILES} ${LDLIBSOPTIONS} -T./fnirsi_sd_card_bootloader.ld -nostdlib -lgcc

${OBJECTDIR}/bl_display_lib.o: bl_display_lib.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bl_display_lib.o bl_display_lib.c

${OBJECTDIR}/bl_fonts.o: bl_fonts.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bl_fonts.o bl_fonts.c
...
${OBJECTDIR}/bl_fpga_control.o: bl_fpga_control.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bl_fpga_control.o bl_fpga_control.c

${OBJECTDIR}/bl_sd_card_interface.o: bl_sd_card_interface.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bl_sd_card_interface.o bl_sd_card_interface.c

${OBJECTDIR}/bl_uart.o: bl_uart.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bl_uart.o bl_uart.c

${OBJECTDIR}/bl_variables.o: bl_variables.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bl_variables.o bl_variables.c
...
${OBJECTDIR}/fnirsi_1014d_startup.o: fnirsi_1014d_startup.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fnirsi_1014d_startup.o fnirsi_1014d_startup.c
