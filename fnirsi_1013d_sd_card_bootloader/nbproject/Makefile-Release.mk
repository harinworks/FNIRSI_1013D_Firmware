...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_1013d_sd_card_bootloader

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_1013d_sd_card_bootloader: ${OBJECTFILES}
...
${OBJECTDIR}/fnirsi_1013d_sd_card_bootloader.o: fnirsi_1013d_sd_card_bootloader.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fnirsi_1013d_sd_card_bootloader.o fnirsi_1013d_sd_card_bootloader.c
